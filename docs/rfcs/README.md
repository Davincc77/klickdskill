...
| 009 | [`.klickd v4.1 — Chimera` (portable competence architecture)](./RFC-009-chimera-v4.1.md) · companion: [`chimera/README.md`](./chimera/README.md) · first concrete pack scaffold: [`chimera/packs/student.md`](./chimera/packs/student.md) (`x.klickd/student`) | `.klickd v4.1` (post-`v4.0.0` GA; pack track) | Draft (2026-05-26) |
| 010 | [`pack_memory_compression` (extracted-facts / entity-linking / retrieval-compression pattern, pack-scoped)](./RFC-010-pack-memory-compression.md) · example: [`examples/pack_memory_compression-v1.example.json`](./examples/pack_memory_compression-v1.example.json) | `.klickd v4.2` (post-v4.1 Chimera; pack-scoped `compressed_memory` track — NOT a v4.1 candidate skill artefact, NOT in scope for v4.0 GA) | Draft (2026-05-28) |
