...
**DOI:** [10.5281/zenodo.20262530](https://doi.org/10.5281/zenodo.20262530) — latest version: [10.5281/zenodo.20274327](https://zenodo.org/records/20274327)
...
- **v3.0 (skill) / envelope 2.0 — 2026-05-18** — "One soul. Any model. Any body." framing. Cross-impl CLEAN PASS (Python + JS). DOI published: 10.5281/zenodo.20262530. v3.1 (Grok Audits 1+2+3 — all fixes): 10.5281/zenodo.20274327. Robotics section expanded with "Any body" explanation.
