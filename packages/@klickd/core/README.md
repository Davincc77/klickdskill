...
Four real, structured, downloadable starter `.klickd` skills ship under [`examples/v4/chimera-packs/`](https://github.com/Davincc77/klickdskill/tree/main/examples/v4/chimera-packs):
