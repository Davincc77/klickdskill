...
> The packs are **not yet included as PyPI package data**. Updating this live PyPI page to include them as `package_data` will require a future patch release of `klickd`. Until then, fetch them directly from the GitHub source above.
